...
public class CForce
{
    ...
    private static double m_repulsefactortoped = 0.12*m_pixelpermeter;//0.1*m_pixelpermeter;
    private static double m_sigma = 0.06*m_pixelpermeter;//0.25*m_pixelpermeter;
