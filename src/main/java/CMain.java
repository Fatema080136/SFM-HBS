...
public class CMain extends JFrame
{
    ...
    public static void main( String []args ) throws InterruptedException
    {
        ...
        //to write simulation output
        final String l_name = System.getProperty("user.dir").concat("/TUC_dataset" +
                "circular.csv");
        ...
        for(int s = 1; s <=104; s++)
        {
            ...
            List<CInputFormat> l_roadusers = CCsvFileReader.readDataFromCSV(System.getProperty("user.dir").concat("/start_end_tuc_extended_goal.csv"), s);
